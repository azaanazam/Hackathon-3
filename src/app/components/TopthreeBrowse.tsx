    ...
    <div className="max-sm:w-[358px] max-sm:h-[1075px] max-sm:left-[16px]   w-[1239px] h-[866px] relative left-[100px]  rounded-[40px] bg-[#d5dedb] ">
      ...
      <div className="max-sm:grid max-sm:pt-[108px] flex pt-[192px] relative rounded-[20px] ">
        ...
        <div className="bg-bannerImgFour  bg-repeat bg-cover bg-bottom w-[407px] h-[289px] rounded-[20px] relative left-[40px] max-sm:w-[310px] max-sm:h-[190px] max-sm:left-[24px] max-sm:mt-[24px]  ">
          <p className="w-[114px] h-[49px] relative mt-[25px] left-[16px] font-bold text-[36px] leading-[48px] max-sm:w-[310px] max-sm:h-[190px] max-sm:left-[0px] max-sm:mt-[24px] ">Gym</p>
